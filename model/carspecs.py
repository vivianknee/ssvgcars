...
def initCarspecs():
    with app.app_context():
        ...
        s1 = CarSpec(name='Chevrolet Blazer', type='SUV', seatingCapacity='5', powerSource='Gasoline', transmission='Automatic', mileage='b', range='Non-Electric')
        s2 = CarSpec(name='Chevrolet Blazer EV', type='SUV', seatingCapacity='5', powerSource='Electric', transmission='Automatic', mileage='Non-Gasoline', range='3') 
        ...
        s4 = CarSpec(name='Chevrolet Equinox', type='SUV', seatingCapacity='5', powerSource='Gasoline', transmission='Automatic', mileage='b', range='Non-Gasoline')
        s5 = CarSpec(name='Chevrolet Equinox EV', type='SUV', seatingCapacity='5', powerSource='Electric', transmission='Automatic', mileage='Non-Gasoline', range='2')
        s6 = CarSpec(name='Chevrolet Trailblazer', type='SUV', seatingCapacity='5', powerSource='Gasoline', transmission='Automatic', mileage='b', range='Non-Electric') 
        s7 = CarSpec(name='Chevrolet Traverse', type='SUV', seatingCapacity='7', powerSource='Gasoline', transmission='Automatic', mileage='b', range='Non-Electric')
        s8 = CarSpec(name='Chevrolet Seeker', type='SUV', seatingCapacity='5', powerSource='Gasoline', transmission='Automatic', mileage='c', range='Non-Electric')
        s9 = CarSpec(name='Chevrolet Suburban', type='SUV', seatingCapacity='8', powerSource='Gasoline', transmission='Automatic', mileage='a', range='Non-Electric')
        s10 = CarSpec(name='Chevrolet Tahoe', type='SUV', seatingCapacity='8', powerSource='Gasoline', transmission='Automatic', mileage='a', range='Non-Electric') 
        s11 = CarSpec(name='Chevrolet Colorado', type='Pickup Truck', seatingCapacity='5', powerSource='Gasoline', transmission='Automatic', mileage='a', range='Non-Electric')

        carspecs = [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11]
        try:
            db.session.query(CarSpec).delete()
            db.session.commit()
        except:
            db.session.rollback()
